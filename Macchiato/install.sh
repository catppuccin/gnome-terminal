...
dconf write "$profile_path"background-color "'#24273a'"
...
dconf write "$profile_path"cursor-foreground-color "'#24273a'"
dconf write "$profile_path"cursor-background-color "'#f4dbd6'"
